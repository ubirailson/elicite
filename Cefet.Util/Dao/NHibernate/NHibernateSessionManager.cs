...
namespace Cefet.Util.Dao.NHibernate
{
    /// <summary>
    ...
    public sealed class NHibernateSessionManager
    {
        ...
        private void InitSessionFactory()
        {
            ...
            // Dá a certeza de que o web.config contém uma declaração para o HBM_ASSEMBLY appSetting
                ...
                System.Configuration.ConfigurationManager.AppSettings["HBM_ASSEMBLY"] == "")
            {
                throw new System.Configuration.ConfigurationErrorsException("NHibernateManager.InitSessionFactory: \"HBM_ASSEMBLY\" deve ser " +
                    "provido como um appSetting dentro do seu arquivo de configuração. \"HBM_ASSEMBLY\" informa ao NHibernate o assembly que " +
                    "contém os arquivos HBM. Ele assume que os arquivos HBM estão com suas propriedades configuradas como \"embedded resources\"." +
                    "Um exemplo de configuração é a declaração <add key=\"HBM_ASSEMBLY\" value=\"MyProject.Core\" />");
            }
        ...
        public void RegisterInterceptor(IInterceptor interceptor)
        {
            ...
            {
                throw new CacheException("Você não pode registrar um interceptador uma vez que uma sessão já foi aberta.");
            }
        ...
        public void BeginTransaction()
        {
            ...
            {
                throw new DaoException("Erro de conexão", e);
            }
        }
